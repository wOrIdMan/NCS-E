...
if(prob_k == 34)
    ...
    if initial_flag == 0
        G = load('benchmark/CEC2020/input data/FunctionPS1_G.txt');
        B = load('benchmark/CEC2020/input data/FunctionPS1_B.txt');
        P = load('benchmark/CEC2020/input data/FunctionPS1_P.txt');
        Q = load('benchmark/CEC2020/input data/FunctionPS1_Q.txt');
        initial_flag = 1;
    end
    Y = G+1j*B;
...
if(prob_k == 35)
    ...
    if initial_flag == 0
        G = load('benchmark/CEC2020/input data/FunctionPS2_G.txt');
        B = load('benchmark/CEC2020/input data/FunctionPS2_B.txt');
        P = load('benchmark/CEC2020/input data/FunctionPS2_P.txt');
        Q = load('benchmark/CEC2020/input data/FunctionPS2_Q.txt');
        initial_flag = 1;
    end
    Y = G+1j*B;
    %% voltage initilization
...
if(prob_k == 37)
    ...
    if initial_flag == 0
        G = load('benchmark/CEC2020/input data/FunctionPS11_G.txt');
        B = load('benchmark/CEC2020/input data/FunctionPS11_B.txt');
        P = load('benchmark/CEC2020/input data/FunctionPS11_P.txt');
        Q = load('benchmark/CEC2020/input data/FunctionPS11_Q.txt');
        initial_flag = 1;
    end
    Y = G+1j*B;
    %% voltage initilization
...
if (prob_k == 40)
   ...
   if initial_flag == 0
        P = load('benchmark/CEC2020/input data/FunctionPS2_P.txt');
        Q = load('benchmark/CEC2020/input data/FunctionPS2_Q.txt');
        L = load('benchmark/CEC2020/input data/FunctionPS14_linedata.txt');
        initial_flag = 1;
   end
    %% voltage initilization
    V = zeros(38,1);
...
if (prob_k == 51)
    ...
    if initial_flag == 0
        P = load('benchmark/CEC2020/input data/FunctionRM_feed.txt');
        initial_flag = 1;     
    end
    %% objective function
...
if (prob_k == 55)
    ...
    if initial_flag == 0
        P = load('benchmark/CEC2020/input data/FunctionRM_dairy.txt');
        initial_flag = 1;     
    end
    %% objective function
    f = sum(x.*repmat(P(1,:),ps,1),2); 
